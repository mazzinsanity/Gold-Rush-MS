...
#define DECOMPOSITION_TIME 18 MINUTES
#define DECOMPOSITION_TIME_RAW 8 MINUTES
#define DECOMPOSITION_TIME_GROSS 8 MINUTES //Mojave Edit - Changed these decomp times to better match the fact we aren't hyper speed TG paced. Original values are 10-5-7 minutes
