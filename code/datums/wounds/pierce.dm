...
/datum/wound/pierce/bleed/handle_process(delta_time, times_fired)
...
/datum/wound/pierce/bleed/on_stasis(delta_time, times_fired)
	. = ..()
	if(blood_flow <= 0)
		qdel(src)
...
/datum/wound/pierce/bleed/get_limb_examine_description()
...
/datum/wound/pierce/bleed/moderate
	...
	threshold_penalty = 20 //Unchanged from original TG value
...
/datum/wound_pregen_data/flesh_pierce/breakage
	...
	threshold_minimum = 25 //MOJAVE SUN EDIT - Original TG value is 30
...
/datum/wound/pierce/bleed/critical
	...
	//MOJAVE EDIT CHANGE BEGIN
	initial_flow = 3 //Unchanged from original TG value
