...
/obj/item/stack/medical/gauze
	name = "medical gauze"
	desc = "A roll of elastic cloth, perfect for stabilizing all kinds of slashes, punctures and burns. "	// MOJAVE SUN EDIT - ORIGINAL IS desc = "A roll of elastic cloth, perfect for stabilizing all kinds of wounds, from cuts and burns, to broken bones. "
	gender = PLURAL
	...
	var/gauze_type = /datum/bodypart_aid/gauze // MOJAVE SUN EDIT
...
/obj/item/stack/medical/gauze/improvised
	...
	//splint_factor = 0.85 - MOJAVE SUN EDIT
	burn_cleanliness_bonus = 0.7
	// absorption_rate = 0.075 - MOJAVE SUN EDIT
	// absorption_capacity = 4 - MOJAVE SUN EDIT
	merge_type = /obj/item/stack/medical/gauze/improvised
	gauze_type = /datum/bodypart_aid/gauze/improvised // MOJAVE SUN EDIT
	/*
